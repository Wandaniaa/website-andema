...
<head>
    ...
    <title><?php echo "Distributor of Hempel Paint in Aceh and Medan (Sumatera Utara)"; ?></title>
    <meta name="description"
        content="Andema is Distributors agent in Aceh and Sumatera Utara (Medan) based region. This All Catalogue of Hempel Paint products from primer , intermediate, finishing and etc.">
...
<body class="body-product">
    ...
    <div class="container wrapped">
        <div class="middle-image">
            <img class="img-responsive" src="hempel.jpg" />
        </div>
        <div class="content">
            <div class="sub-nav">
                <ul class="nav nav-pills">
                    <li class=""><a id="catalog" title="Hempel - All Product"
                    ...
                    <li class="active"><a id="color" title="Hempel Paint" href="/product/hempel/">Hempel Paint</a></li>
                    <!--<li><a id="color" title="PPG Coating" href="/product/ppg-coatings/">PPG-Coatings</a></li>-->
                    <li><a id="color" title="Kcc Paint" href="/product/kcc/">KCC Paint</a></li>
            ...
            <div class="row">
                ...
                <?php
                $sql = "SELECT nama,deskripsi,volume_solids,typical_dft FROM hempel where deskripsi <> '' ";
                ...
                while(($count<$rpp) && ($i<$tcount)) {
                    echo "<div class=\"card\">
                        ...
                        <h4 class=\"card-title\">Volume Solid</h4>
                        <p class=\"card-text\">{$data[$i]["volume_solids"]}</p>
                        <h4 class=\"card-title\">Typical DFT</h4>
                        <p class=\"card-text\">{$data[$i]["typical_dft"]}</p>
                        </div>
                        </div></br>";
