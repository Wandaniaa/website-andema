        ...
        <div class="content">
            <div class="sub-nav">
                <ul class="nav nav-pills">
                    <li class="active"><a id="catalog" title="International Paint - All Product" href="/product/">Catalogue</a></li>
                    ...
                    <li><a id="color" title="Carboline Paint" href="/product/kcc/">KCC Paint</a></li>

                </ul>
            </div>
            <hr class="orange" />

            <img class="img-responsive" src="/assets/images/under.jpg" alt="under construction"/>
        </div><!-- content-->
