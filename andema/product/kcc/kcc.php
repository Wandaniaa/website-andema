...
<body class="body-product">
    ...
    <img src="/assets/images/kccpaint.jpg" style="width:100%; height:100%; object-fit:cover;" /> 
    </div>
        <div class="content">
            <div class="sub-nav">
                <ul class="nav nav-pills">
                    <li><a id="catalog" title="International Paint - All Product" href="/product/">Catalogue</a></li>
                    ...
                    <li class="active"><a id="color" title="Carboline Paint" href="/product/kcc/">KCC Paint</a></li>

                </ul>
            </div>
            <hr class="orange" />

            <img class="img-responsive" src="/assets/images/floor.jpg" alt="under construction"/>
        </div><!-- content-->
